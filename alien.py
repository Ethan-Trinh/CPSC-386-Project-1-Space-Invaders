...
class Alien(Sprite):
    alien_images0 = [pg.image.load(f'images/alien/alien0{n}.png') for n in range(2)]
    alien_images1 = [pg.image.load(f'images/alien/alien1{n}.png') for n in range(2)]
    alien_images2 = [pg.image.load(f'images/alien/alien2{n}.png') for n in range(2)]
    alien_images3 = [pg.image.load(f'images/alien/alien3{n}.png') for n in range(2)]
    #alien3 == UFO
    ...
    def __init__(self, game, type):
        ...
        self.image = pg.image.load('images/alien/alien00.png')
...
class Aliens:
    ...
    def get_number_aliens_x(self, alien_width):
        available_space_x = self.settings.screen_width - 9 * alien_width
